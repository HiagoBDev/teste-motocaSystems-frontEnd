  ...
  return (
    <div className="flex flex-col sm:flex-row sm:gap-10">
        ...
        <div className="text-[#E7E3FC] flex flex-col sm:gap-3 gap-1">
          ...
          <p className=' font-medium text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px]'>Valor: R$ {value}</p>
          <p className=' font-medium text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px]'>Cor: {color}</p>
        </div>
    </div>
  )
}

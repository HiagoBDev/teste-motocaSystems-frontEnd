...
export default function OpenMenu({ isOpen, onClose }:OpenMenuProps) {
  return (
    <div className={`fixed top-0 right-0 w-64 h-full bg-gray-800 text-white shadow-lg z-50 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
    <div>
